  ...
  if ( ciphT == "" ) {
    ...
    for (var i = 0; i < digrams.length; i++) {
      ...
      if (mod5Result == 0) {
        ...
        if (letterPosition1 <= 4) { // Se estiver no topo da coluna
          tempString += matrix[letterPosition1 + 20]; // Mover para baixo
          tempString += matrix[letterPosition2 - 5]; // Escolher entre o elemento
        }
